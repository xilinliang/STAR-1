...
for ($i=0;$i<$number_input;$i++)
{
	...
	{
		$file_id = $i / 6;
		$outputFile=$folder."/EemcTrigCount_P$file_id".".C";
		$outputFilename="EemcTrigCount_P$file_id";
		print $outputFile;
	...
	my $outputFilePrint = $folder."/root_result/TrigRunAveEEMC/DiffJetTrigCount$fill"."_0325.root";

	print Output 'DiffJetTrigCount("'."$inputFilePrint".'","'."$outputFilePrint".'","eemc");'."\n";
